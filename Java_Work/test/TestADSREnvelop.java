public class TestADSREnvelop {
    public static void main(String[] args) {
        ...
        GenSine gen = new GenSine("SineModulated", 0.0); // amplitude sera modulée
        ...
        patch.connect("Envelope", 0, "SineModulated", 1);

        // Connexion : sortie sinusoïdale → sortie audio
        patch.connect("SineModulated", 0, "output", 0);
